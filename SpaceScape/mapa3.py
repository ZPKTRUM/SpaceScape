...
pygame.display.set_caption("Mapa 3")
...
# Colores
floor_color = (50, 50, 50)  # Color del piso
wall_color = (70, 70, 70)   # Color de las paredes
...
# Lista de monedas (posiciones estratégicas)
coins = [
    Coin(1000, 600),  # Coin near starting point
    Coin(1300, 1000),  # Coin guiding towards the right
    Coin(1600, 1400),  # Coin further guiding towards the bottom-right
    Coin(2000, 1600),  # Coin near the new box location
    Coin(2200, 1700)   # Coin just before the box
]
...
box_rect = pygame.Rect(2340, 1800, 60, 60) # nueva posicion del cofre
...
def mostrar_mensaje_nivel():
    screen.fill((0, 0, 0))
    font = pygame.font.Font(None, 72)
    text_surface = font.render("¡Nivel 3 desbloqueado!", True, (0, 255, 0))
