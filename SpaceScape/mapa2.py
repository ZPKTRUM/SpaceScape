...
pygame.display.set_caption("Mapa 2")
...
coins = [
    ...
    Coin(1200, 700),  # Coin guiding towards the center
    Coin(1500, 800),  # Coin further guiding towards the center
    Coin(1900, 900),  # Coin near the new box location
    Coin(2100, 950)   # Coin just before the box
]
...
box_rect = pygame.Rect(2160, 960, 60, 60) # nueva posicion del cofre
...
def mostrar_mensaje_nivel():
    screen.fill((0, 0, 0))
    font = pygame.font.Font(None, 72)
    text_surface = font.render("¡Nivel 2 desbloqueado!", True, (0, 255, 0))
